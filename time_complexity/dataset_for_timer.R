...
## In our experiment, we use data under
## TabulaMuris / data / leukocytes_normalized_data.rds
...
save_sampled_data <- function(mycnm) {
  ...
  saveRDS(object = logtpm,
          file = here::here("TabulaMuris", "supplement", "timer", fnm))
}
